...
class BackgroundInfo(Frame):
    ...
    def create_widgets(self):
        ...
        text1 = Label(self, text="Year 2845, the Gods have abandoned human civilization. No one knows what exactly", font="Luminari 24")
        ...
        text5 = Label(self, text="turned this way, and those who smiled and hugged their pets were bitten. Those", font="Luminari 24")
        text5.grid(row=8, column=0, columnspan=4, pady=(0, padding))
        text6 = Label(self, text="who were bitten, then took the form of more horrifying creatures that can no", font="Luminari 24")
        text6.grid(row=9, column=0, columnspan=4, pady=(0, padding))
        text7 = Label(self, text="longer be called \'human\'.", font="Luminari 24")
