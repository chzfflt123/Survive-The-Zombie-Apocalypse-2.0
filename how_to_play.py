...
class How_To_Play(Frame):
    ...
    def create_widgets(self):
        ...
        info1 = Label(self,text="Press the buttons corresponding to whichever action you want to make", font="Ariel 26",width=62)
        info1.grid(row=4, column=1, sticky=N, pady=(0, padding))
        info2 = Label(self,text="You could either go have fun or stay at home", font="Ariel 26",width=62)
        info2.grid(row=5, column=1, sticky=N, pady=(0, padding))
        info3 = Label(self,text="If you get out of base there are many things that may happen, based on the decisions you make", font="Ariel 26",width=62)
        info3.grid(row=6, column=1, sticky=N, pady=(0, padding))
        info4 = Label(self,text="Survive and Return to base with MONEY!!! or supplies.", font="Ariel 26",width=62)
        info4.grid(row=7, column=1, sticky=N, pady=(0, padding))
        info5 = Label(self,text="Make sure to manage supplies and health -- new party members can bring supplies but also have mysterious effects.", font="Ariel 26",width=62)
        info5.grid(row=8, column=1, sticky=N, pady=(0, padding))
        info7 = Label(self,text="Stay Alive. MWAHAHAHAHAHA", font="Ariel 26",width=62)
        info7.grid(row=9, column=1, sticky=N, pady=(0, padding))

        spacing4=Label(self,text=" ",height=3)
        spacing4.grid(row=10,column=1,sticky=E)
        ...
        spacing5.grid(row=12,column=1,sticky=E)
